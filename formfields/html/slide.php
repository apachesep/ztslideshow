...
<div class="slider-toggle">
    ...
    <div class="toggle-background clearfix">
        <select onchange="zo2.modules.slideshow.backgroundToggle(this);" name="background-type" class="span12" tabindex="6">
            <option <?php echo ($slide->get('background-type') == 'image') ? 'selected="selected"' : ''; ?> value="image" data-value="toggle-image">Image</option>
            <option <?php echo ($slide->get('background-type') == 'video') ? 'selected="selected"' : ''; ?> value="video" data-value="toggle-video">Video</option>
            <option <?php echo ($slide->get('background-type') == 'color') ? 'selected="selected"' : ''; ?> value="color" data-value="toggle-color">Color</option>
        </select>
    </div>
    <div class="toggle-background-setting clearfix">
        <div class="slider-element slider-text" id="toggle-color" <?php echo ($slide->get('background-type') == 'color') ? 'style="display:block"' : ''; ?>>
        ...
        <div class="slider-element slider-text slide-image" id="toggle-image" <?php echo ($slide->get('background-type') == 'image') ? 'style="display:block"' : ''; ?>>
        ...
        <div class="slider-element slider-text" id="toggle-video" <?php echo ($slide->get('background-type') == 'video') ? 'style="display:block"' : ''; ?>>
    ...
    <div class="span6">
        <div class="position-left element-position">
            ...
            <div class="slider-element slider-select">
                <label>Type</label>
                <select onchange="zo2.modules.slideshow.typeToggle(this);" name="l-type" class="span12" tabindex="6">
                    <option <?php echo ($slide->get('l-type') == 'image') ? 'selected="selected"' : ''; ?> value="image">Image</option>
                    <option <?php echo ($slide->get('l-type') == 'embed') ? 'selected="selected"' : ''; ?> value="embed">Embed video</option>
                    <option <?php echo ($slide->get('l-type') == 'text') ? 'selected="selected"' : ''; ?> value="text">Text</option>
                </select>
            </div>
            <div class="slider-element element-toggle slide-image" <?php echo ($slide->get('l-type') == 'image') ? 'style="display:block"' : 'style="display: none"'; ?>>
                <label>Image</label>
                <input name="l-image" class="span12" placeholder="Choose Image" type="text"
                       value="<?php echo $slide->get('l-image'); ?>">
                <?php echo JLayoutHelper::render('joomla.editors.buttons.button', $button); ?>
            </div>
            <div class="slider-element element-toggle slide-embed" <?php echo ($slide->get('l-type') == 'embed') ? 'style="display:block"' : 'style="display: none"'; ?>>
                <label>Embed code</label>
                <textarea name="l-embed" class="span12" placeholder="Fill code embed" type="text"><?php echo $slide->get('l-embed'); ?></textarea>
            </div>
            <div class="slider-element element-toggle slide-text" <?php echo ($slide->get('l-type') == 'text') ? 'style="display:block"' : 'style="display: none"'; ?>>
                <label>Title</label>
            ...
            <div class="slider-element element-toggle slide-text" <?php echo ($slide->get('l-type') == 'text') ? 'style="display:block"' : 'style="display: none"'; ?>>
                ...
                <input name="l-text-link" class="span12" placeholder="Fill Text Link" value="<?php echo $slide->get('l-text-link'); ?>" />
            </div>
            <div class="slider-element element-toggle slide-text" <?php echo ($slide->get('l-type') == 'text') ? 'style="display:block"' : 'style="display: none"'; ?>>
                <label>Link</label>
                <input name="l-link" class="span12" placeholder="Fill Link" value="<?php echo $slide->get('l-link'); ?>" />
            </div>
            ...
            <div class="slider-element slider-column">
                ...
                <select name="l-column" class="span12 select-column">
                    <option <?php echo ($slide->get('l-column') == 'none') ? 'selected="selected"' : ''; ?> value="none">none</option>
                    <option <?php echo ($slide->get('l-column') == '1') ? 'selected="selected"' : ''; ?> value="1">1</option>
                    <option <?php echo ($slide->get('l-column') == '2') ? 'selected="selected"' : ''; ?> value="2">2</option>
                    <option <?php echo ($slide->get('l-column') == '3') ? 'selected="selected"' : ''; ?> value="3">3</option>
                    <option <?php echo ($slide->get('l-column') == '4') ? 'selected="selected"' : ''; ?> value="4">4</option>
                    <option <?php echo ($slide->get('l-column') == '5') ? 'selected="selected"' : ''; ?> value="5">5</option>
                    <option <?php echo ($slide->get('l-column') == '6') ? 'selected="selected"' : ''; ?> value="6">6</option>
                    <option <?php echo ($slide->get('l-column') == '7') ? 'selected="selected"' : ''; ?> value="7">7</option>
                    <option <?php echo ($slide->get('l-column') == '8') ? 'selected="selected"' : ''; ?> value="8">8</option>
                    <option <?php echo ($slide->get('l-column') == '9') ? 'selected="selected"' : ''; ?> value="9">9</option>
                    <option <?php echo ($slide->get('l-column') == '10') ? 'selected="selected"' : ''; ?> value="10">10</option>
                    <option <?php echo ($slide->get('l-column') == '11') ? 'selected="selected"' : ''; ?> value="11">11</option>
                    <option <?php echo ($slide->get('l-column') == '12') ? 'selected="selected"' : ''; ?> value="12">12</option>
                </select>
            </div>
        ...
        <div class="position-right element-position">
            ...
            <div class="slider-element slider-select">
                ...
                <select onchange="zo2.modules.slideshow.typeToggle(this);" name="r-type" class="span12 select-type">
                    <option <?php echo ($slide->get('r-type') == 'image') ? 'selected="selected"' : ''; ?> value="image">Image</option>
                    <option <?php echo ($slide->get('r-type') == 'embed') ? 'selected="selected"' : ''; ?> value="embed">Embed video</option>
                    <option <?php echo ($slide->get('r-type') == 'text') ? 'selected="selected"' : ''; ?> value="text">Text</option>
                </select>
            </div>
            <div class="slider-element element-toggle slide-image" <?php echo ($slide->get('r-type') == 'image') ? 'style="display:block"' : 'style="display:none"'; ?>>
                <label>Image</label>
                <input name="r-image" class="span12" placeholder="Choose Image" type="text"
                       value="<?php echo $slide->get('r-image'); ?>">
                <?php echo JLayoutHelper::render('joomla.editors.buttons.button', $button); ?>
            </div>
            <div class="slider-element element-toggle slide-embed" <?php echo ($slide->get('r-type') == 'embed') ? 'style="display:block"' : 'style="display:none"'; ?>>
                <label>Embed code</label>
                <textarea name="r-embed" class="span12" placeholder="Fill code embed" type="text"><?php echo $slide->get('r-embed'); ?></textarea>
            </div>
            <div class="slider-element element-toggle slide-text" <?php echo ($slide->get('r-type') == 'text') ? 'style="display:block"' : 'style="display:none"'; ?>>
                <label>Title</label>
            ...
            <div class="slider-element element-toggle slide-text" <?php echo ($slide->get('r-type') == 'text') ? 'style="display:block"' : 'style="display: none"'; ?>>
                <label>Text Link</label>
                <input name="r-text-link" class="span12" placeholder="Fill Text Link" value="<?php echo $slide->get('r-text-link'); ?>" />
            </div>
            <div class="slider-element element-toggle slide-text" <?php echo ($slide->get('r-type') == 'text') ? 'style="display:block"' : 'style="display: none"'; ?>>
                <label>Link</label>
                <input name="r-link" class="span12" placeholder="Fill Link" value="<?php echo $slide->get('r-link'); ?>" />
            </div>
            <div class="slider-element slider-position clearfix">
                <label>Position</label>
                <ul>
            ...
            <div class="slider-element slider-column">
                ...
                <select name="r-column" class="span12 select-column">
                    <option <?php echo ($slide->get('r-column') == 'none') ? 'selected="selected"' : ''; ?> value="none">none</option>
                    <option <?php echo ($slide->get('r-column') == '1') ? 'selected="selected"' : ''; ?> value="1">1</option>
                    <option <?php echo ($slide->get('r-column') == '2') ? 'selected="selected"' : ''; ?> value="2">2</option>
                    <option <?php echo ($slide->get('r-column') == '3') ? 'selected="selected"' : ''; ?> value="3">3</option>
                    <option <?php echo ($slide->get('r-column') == '4') ? 'selected="selected"' : ''; ?> value="4">4</option>
                    <option <?php echo ($slide->get('r-column') == '5') ? 'selected="selected"' : ''; ?> value="5">5</option>
                    <option <?php echo ($slide->get('r-column') == '6') ? 'selected="selected"' : ''; ?> value="6">6</option>
                    <option <?php echo ($slide->get('r-column') == '7') ? 'selected="selected"' : ''; ?> value="7">7</option>
                    <option <?php echo ($slide->get('r-column') == '8') ? 'selected="selected"' : ''; ?> value="8">8</option>
                    <option <?php echo ($slide->get('r-column') == '9') ? 'selected="selected"' : ''; ?> value="9">9</option>
                    <option <?php echo ($slide->get('r-column') == '10') ? 'selected="selected"' : ''; ?> value="10">10</option>
                    <option <?php echo ($slide->get('r-column') == '11') ? 'selected="selected"' : ''; ?> value="11">11</option>
                    <option <?php echo ($slide->get('r-column') == '12') ? 'selected="selected"' : ''; ?> value="12">12</option>
                </select>
            </div>
            <div class="slider-element slider-text">
                <label>Effect</label>
