...
?>
<div id="zt-slideshow-wrap<?php echo $module->id; ?>" class="zt-slideshow-wrap" style="width: <?php echo $params->get('slider_width'); ?>; heigt: <?php echo $params->get('slider_height'); ?>">
